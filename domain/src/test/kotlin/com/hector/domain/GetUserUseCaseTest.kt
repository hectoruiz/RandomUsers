...
class GetUserUseCaseTest {
    ...
    fun `error fetching users from remote`() {
        ...
        coEvery { userRepository.getUser("123") } returns errorResponse


        val result = runBlocking { getUserUseCase.getUser("123").first() }
    ...
    fun `success fetching users from remote`() {
        ...
        coEvery { userRepository.getUser("123") } returns successResponse
